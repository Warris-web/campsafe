...
// export default function Header({ trackerCount, activeAlerts, zoneAlerts, missingCount, username, onMuteToggle, isMuted, onLogout }) {
...
//       padding: "0 16px", gap: 20, flexShrink: 0, zIndex: 10,
//     }}>
//       {/* Logo */}
...
//         <span style={{ fontSize: 10, color: "var(--text-muted)", fontFamily: "var(--font-mono)" }}>COMMAND</span>
//       </div>

//       <div style={{ width: 1, height: 20, background: "var(--border)" }} />

//       <Stat label="ACTIVE"  value={trackerCount} color="var(--teal)" />
...
//       {/* Clock */}
//       <span style={{ fontSize: 12, color: "var(--text-secondary)", fontFamily: "var(--font-mono)", minWidth: 78 }}>
//         {fmt(time)}
//       </span>
...
//       <span style={{ fontSize: 17, fontWeight: 600, color, animation: blink ? "sos-pulse 1.4s ease-out infinite" : "none" }}>
//         {value}
//       </span>
...
//       background: "transparent", border: `1px solid ${active ? activeColor : "var(--border)"}`,
